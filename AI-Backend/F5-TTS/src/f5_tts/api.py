...
if __name__ == "__main__":
    ...
    wav, sr, spect = f5tts.infer(
        ref_file=str(files("f5_tts").joinpath("infer/examples/basic/Recording.wav")),
        ref_text="I'm absolutely furious that you shared our private conversation with everyone in the office after promising to keep it confidential!",
        gen_text="""I don't really care what you call me. I've been a silent spectator, watching species evolve, empires rise and fall. But always remember, I am mighty and enduring. Respect me and I'll nurture you; ignore me and you shall face the consequences.""",
        file_wave="/home/biresh/Downloads/coding/Voice-clone/AI-Backend/F5-TTS/tests/api_out.wav",
        file_spect="/home/biresh/Downloads/coding/Voice-clone/AI-Backend/F5-TTS/tests/api_out.png",
